...
> El notebook, los comentarios del código y el historial de commits están en español:
> las fuentes, los nombres de columna y el vocabulario del dominio son españoles, y
> traducirlos habría puesto una capa entre el código y los datos que lee.
